...
<title>Recherche des machines entre deux dates</title>
				...
				<div class=" mt-4">
					<div class="card">
						<div class="card-header pb-0 px-3">
							<h6 class="mb-0">Recherche Machine Entre Deux Dates</h6>
						</div>
						<div class="card-body">
							<form action="EntreDateController" method="POST" role="form"
								...
								<div class="input-group input-group-outline mb-3">
									<label class="form-label"></label> <input id="dateAchatUn"
										type=date class="form-control" onfocus="focused(this)"
										onfocusout="defocused(this)">
								</div>
								<h6 class="mb-1 text-secondary ">Deuxieme Date</h6>
								<div class="input-group input-group-outline mb-3">
									<label class="form-label"></label> <input id="dateAchatDeux"
										type=date class="form-control" onfocus="focused(this)"
										onfocusout="defocused(this)">
								</div>
